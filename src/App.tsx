import { AdminContainer, AdminSidebar, AdminTopbar, VerticalNav, icons } from "./components"
...
function App() {
  return (
    <AdminContainer
      ...
      allowDarkMode={true}
    >
      <AdminTopbar height="3rem" />
      <AdminSidebar style={{ backgroundColor: "red" }}>hello</AdminSidebar>
      {/* <AdminSidebar>
          <VerticalNav
            items={[
